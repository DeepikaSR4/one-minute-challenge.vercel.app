      ...
      <main className="flex-1 flex flex-col items-center text-center px-4 relative pt-40">
        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <h1 className="text-5xl md:text-7xl font-display font-bold tracking-tight leading-tight">
            Stop freezing on work calls.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-neon-violet">
              Train how you speak.
            </span>
          </h1>
          ...
          <p className="text-xl text-white/60 font-sans max-w-2xl mx-auto">
            ...
            But under pressure, you hesitate, ramble, or lose structure.
            OneMinute simulates real call scenarios so you practice speaking — not typing.
          </p>
        ...
        <section className="max-w-4xl mx-auto mt-32 space-y-10 text-center px-4">
          <h2 className="text-3xl font-display font-bold">
            This is what usually happens on calls:
          </h2>

          <div className="space-y-4 text-white/60 text-lg">
            <p>• You know the answer — but your brain freezes.</p>
            <p>• You start explaining — and lose structure halfway.</p>
            <p>• You use filler words to buy time.</p>
            <p>• You finish speaking — and wish you said it better.</p>
          </div>
        ...
        <section className="max-w-5xl mx-auto mt-32 mb-20 px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          ...
          <div className="glass p-6 rounded-2xl space-y-4">
            ...
            <p className="text-white/60">
              Realistic simulations: angry client, delay explanation, negotiation, escalation.
          ...
          <div className="glass p-6 rounded-2xl space-y-4">
            ...
            <p className="text-white/60">
              No editing. No rewriting. Just speak like you would in a real call.
            </p>
          </div>
          ...
          <div className="glass p-6 rounded-2xl space-y-4">
            ...
            <h3 className="text-xl font-bold font-display">AI Call Breakdown</h3>
            <p className="text-white/60">
              Get scored on clarity, structure, confidence, and conciseness.
              Plus a sharper 30-second rewrite.
            </p>
          </div>
